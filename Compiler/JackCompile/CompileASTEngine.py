...
#learning some codes about the compile
import xml.etree.ElementTree as ET

from Compiler.JackCompile import consts
from Compiler.JackCompile.symbol_table import SymbolTable
...
class CompilationASTEngine:
    """Gets input from a JackTokenizer and emits its parsed structure into an
    output stream.
    """

    def __init__(self, tokenizer, writer: VMWriter):
        """
